...
| [株式会社ストラテジット](#株式会社ストラテジット)       | 2022/12 ~ 2019/12 | ERP 導入時のカスタマイズ開発/設計/保守           |
...
メインの業務は、EC サイトのカスタマイズ開発です。
ERP システム側に、EC サイトと連携するためのカスタマイズ開発も行っています。
...
- プロジェクト詳細
  - 使用技術: JavaScript, Backbone.js, Oracle SQL, Sass
  - 担当範囲: EC サイトのカスタマイズ開発、ERP システムとの連携開発
  - GitHub を利用したコード管理
  - Slack を利用したお客様とのコミュニケーション
  - バグ発生時の対応/修正
...
業務を可視化し、カイゼンを容易にする業務設計プラットフォームの開発しました。
...
- プロジェクト詳細
  ...
  - 担当範囲: フロントエンド開発、Slack 連携開発
  - GitHub を利用したコード管理
  - ReactFlow を利用した UI 開発
...
#### 大手 IT 企業 ERP 導入 (2022/04 ~ 2022/12)

ERP 導入時のカスタマイズ開発/設計/保守を担当していました。
...
- 仕事では動的型付け言語を使っているため、静的型付け言語を使いたい
- 近年、Rust が注目されているため、学習したい
