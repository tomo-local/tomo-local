...
<p>
  ...
  <img alt="GitLab" src="https://img.shields.io/badge/-GitLab-FCA121.svg?logo=gitlab&style=flat-square" />
...
１次と２次のプロジェクトがあり、お客様の業務全体を把握しているメンバーが自分しかいなかったため、チームリーダー的な役割を担いました。
2次では、お客様のメイン担当者と一緒に、各業務担当者にヒアリングを行い業務整理を行いました。
...
- 新しい技術に興味があり、積極的に学習しています
- ナレッジ共有を積極的に行い、チームとして成長できるように努めます
- 業務改善、効率化でユーザの負担を軽減できるプロダクト開発に携わりたいと考えています

### 興味

- 大規模なシステムの技術に興味があり, 現在は `データ指向アプリケーションデザイン` を読んでいます。
- フロントエンドの技術に興味があり, 現在は `ReactFlow(現：xyflow)` の学習をしています。
- Rust / Go に興味があります。
  - 競技プログラミングでは現在 Rust / Go を使用して学習しています
  - `Rustの練習帳`を読んで、学習しています

## 好きなもの

### プログラミング

プログラミングが好きで、週末に個人開発をしています。
最近は、ReactFlow(現：xyflow) の学習のために、開発をしています。
競技プログラミングもしており、Rust / Go を使用しています。
まだまだ、実務での使用は難しいですが、将来的には実務での使用を目指しています。
